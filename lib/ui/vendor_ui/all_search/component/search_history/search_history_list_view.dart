    ...
    final SerachHistoryListViewAppBar pageviewAppBar =
      ...
      items: <SerachHistoryListViewAppBarItem>[
        SerachHistoryListViewAppBarItem(
            title: 'Все'.tr, mainColor: PsColors.mainColor),
        SerachHistoryListViewAppBarItem(
            title: 'товары'.tr, mainColor: PsColors.mainColor),
        SerachHistoryListViewAppBarItem(
            title: 'Категории'.tr, mainColor: PsColors.mainColor),
        SerachHistoryListViewAppBarItem(
            title: 'Пользователи'.tr, mainColor: PsColors.mainColor),
      ],
    );
