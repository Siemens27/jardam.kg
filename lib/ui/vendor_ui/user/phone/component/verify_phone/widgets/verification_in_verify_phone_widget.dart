...
import 'package:psxmpc/ui/vendor_ui/user/phone/component/verify_phone/widgets/resend_code_widget.dart';
              ...
              if (user != null) {
                ...
                try {
                  await fb_auth.FirebaseAuth.instance
                    ...
                    await gotoProfile(context, user.user!.uid, widget.userName,
                        widget.phoneNumber, provider, widget.onProfileSelected);
                  });
                } on Exception {
                  print('show error');
