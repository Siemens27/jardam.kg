...
class ProductDetailGalleryViewState<T extends ProductDetailGalleryView>
  ...
  Widget build(BuildContext context) {
    ...
    if (itemDetailProvider.product.videoThumbnail!.imgPath != '') {
      selectedDefaultImage = itemDetailProvider.product.videoThumbnail;
      isHaveVideo = true;
    } else {
      selectedDefaultImage = itemDetailProvider.product.defaultPhoto;
      isHaveVideo = false;
    }
