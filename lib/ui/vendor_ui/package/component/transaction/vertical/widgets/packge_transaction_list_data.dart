...
class PackageTransactionListData extends StatefulWidget {
  ...
  @override
  State<PackageTransactionListData> createState() => _PackageTransactionListDataState();
}

class _PackageTransactionListDataState extends State<PackageTransactionListData> {
  @override
  Widget build(BuildContext context) {
    ...
    return SliverList(
      ...
      delegate: SliverChildBuilderDelegate(
        ...
        final PackageTransaction packageTransaction = provider.getListIndexOf(index);
