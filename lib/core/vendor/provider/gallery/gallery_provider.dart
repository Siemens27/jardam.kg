...
class GalleryProvider extends PsProvider<DefaultPhoto> {
  ...
  Future<dynamic> postReorderImages(
    ...
    _apiStatus = await _repo.postReorderImages(
        jsonMap, loginUserId, headerToken, languageCode, isConnectedToInternet, PsStatus.PROGRESS_LOADING);
  ...
  Future<dynamic> postVideoUpload(
    ...
    _defaultPhoto = await _repo.postVideoUpload(itemId, videoId, imageFile!,
        loginUserId, headerToken, languageCode, isConnectedToInternet, PsStatus.PROGRESS_LOADING);
  ...
  Future<dynamic> postChatImageUpload(
    ...
    _defaultPhoto = await _repo.postChatImageUpload(loginUserId, senderId, sellerUserId,
