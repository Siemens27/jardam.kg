...
class PsSharedPreferences {
  ...
  void loadValueHolder() {
    ...
    final int? _recentSearchKeywordLimit =
        shared.getInt(PsConst.VALUE_HOLDER__RECENT_SEARCH_KEYWORD_LIMIT) ?? 0;
    ...
    final int? _autoPlayInterval = shared.getInt(
            PsConst.VALUE_HOLDER__AUTO_PLAY_INTERVAL) ?? 3;
    ...
    await shared.setBool(PsConst.VALUE_HOLDER__IS_PICK_UP_ON_MAP, isPickUpOnMap);
